...
namespace WmiExplorer.Core.WmiWrappers
{
    ...
    public class ManagementBaseObjectW : ICustomTypeDescriptor
    {
        ...
        public ManagementPath ClassPath => _classPath ??= _wrapperObject.ClassPath;
        ...
        public PropertyDataCollection Properties => _properties ??= _wrapperObject.Properties;

        public virtual QualifierDataCollection Qualifiers => _qualifiers ??= _wrapperObject.Qualifiers;

        public virtual PropertyDataCollection SystemProperties => _systemProperties ??= _wrapperObject.SystemProperties;

        public object? this[string propertyName]
        {
            get { return _wrapperObject[propertyName]; }
            set { _wrapperObject[propertyName] = value; }
        }

        protected virtual PropertyDescriptor GetPropertyDescriptor(PropertyData property)
        {
            return new ManagementBaseObjectPropertyDescriptor(this, property);
        }
        ...
        public static Type GetTypeFor(CimType cimType, bool isArray)
        {
            ...
            return typeof(object); // Return object instead of null
        }
